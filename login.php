...
<div class="w3-container"><br><br>
  <h1 style="font-family: 'Quicksand', sans-serif;">Login</h1><br>
  <div class="w3-panel w3-card-4" style="background: lightblue;font-family: 'Quicksand', sans-serif;"><br>
  	...
  	<form method="post" action="includes/login_inc.php">
  		<input type="text" name="username" placeholder="Username" required onfocus="this.value=''" autofocus="autofocus" autocomplete="off"><br>
  		<input type="password" name="password" placeholder="Password" required onfocus="this.value=''" autocomplete="off"><br><?php
      if(isset($_GET['login']))
      {
 ...
 <span style="font-size: 25px;margin-left: 44%;">New User? </span><a href="signup.php" style="text-decoration: none;font-size: 30px;cursor: pointer;color: blue;">signup</a>
